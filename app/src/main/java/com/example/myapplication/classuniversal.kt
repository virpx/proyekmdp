...
class Classuniversal_foodtrack(val id:Int,val nama:String,val jumlah:Int,val calories:Int,val protein:Int,val sugar:Int,val carbs:Int, val fat:Int,val cholesterol:Int,val sodium:Int,val date_add:String){
